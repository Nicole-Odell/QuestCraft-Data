...
execute if score _game_time_mod_40 var matches 0 as @e[type=marker,tag=poi_marker_kingdom,tag=poi_marker_tick] at @s as @n[type=#questcraft:not_in_safe_areas,distance=..160] run function questcraft:banish_entity
...
execute if score _game_time_mod_40 var matches 14 as @e[type=marker,tag=poi_marker_village,tag=poi_marker_tick] at @s as @n[type=#questcraft:not_in_safe_areas,distance=..96] run function questcraft:banish_entity
