...
execute if score _game_time_mod_40 var matches 0 as @e[type=marker,tag=poi_marker_kingdom,tag=poi_marker_tick] at @s as @n[type=#questcraft:not_in_safe_areas,distance=..128] run function questcraft:banish_entity
...
execute if score _game_time_mod_40 var matches 14 as @e[type=marker,tag=poi_marker_village,tag=poi_marker_tick] at @s as @n[type=#questcraft:not_in_safe_areas,distance=..75] run function questcraft:banish_entity
...
execute if score _game_time_mod_40 var matches 27 as @e[type=marker,tag=poi_marker_tavern,tag=poi_marker_tick] at @s as @n[type=#questcraft:not_in_safe_areas,distance=..32] run function questcraft:banish_entity
...
execute if score _game_time_mod_100 var matches 8 as @e[type=marker,tag=poi_marker_kingdom,tag=poi_marker_tick] at @s run function questcraft:enforce_golems {maxGolems:5,spreadSeparation:16,spreadRange:72,checkRange:200}
...
execute if score _game_time_mod_100 var matches 58 as @e[type=marker,tag=poi_marker_village,tag=poi_marker_tick] at @s run function questcraft:enforce_golems {maxGolems:2,spreadSeparation:4,spreadRange:48,checkRange:128}
