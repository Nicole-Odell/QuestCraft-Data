...
$execute as @e[type=#questcraft:is_attack_targetable,tag=blood_bonded_$(mageId)] run function questcraft:mage/spell/bloodbond/remove with storage questcraft:args
