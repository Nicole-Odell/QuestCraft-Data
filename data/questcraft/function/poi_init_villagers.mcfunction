...
execute as @e[type=minecraft:villager,tag=villager_inited_incomplete,distance=..160] at @s run function questcraft:villager_init
execute as @e[type=minecraft:villager,tag=!villager_inited,distance=..160] at @s run function questcraft:villager_init
