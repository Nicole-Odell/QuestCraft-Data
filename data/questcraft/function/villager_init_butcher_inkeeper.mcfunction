...
execute if score _random_val var matches 1 run data modify entity @n[type=marker,tag=poi_marker,distance=..160] data.localStew set value {buy:{id:emerald,count:6},sell:{id:suspicious_stew,count:1,components:{suspicious_stew_effects:[{id:saturation, duration:7}],rarity:uncommon,custom_name:'{"text":"Local Stew"}',lore:['{"text":"A local delicacy. Try it to see what special effects it might have!"}']}},maxUses:10}
execute if score _random_val var matches 2 run data modify entity @n[type=marker,tag=poi_marker,distance=..160] data.localStew set value {buy:{id:emerald,count:6},sell:{id:suspicious_stew,count:1,components:{suspicious_stew_effects:[{id:night_vision, duration:6000}],rarity:uncommon,custom_name:'{"text":"Local Stew"}',lore:['{"text":"A local delicacy. Try it to see what special effects it might have!"}']}},maxUses:10}
execute if score _random_val var matches 3 run data modify entity @n[type=marker,tag=poi_marker,distance=..160] data.localStew set value {buy:{id:emerald,count:6},sell:{id:suspicious_stew,count:1,components:{suspicious_stew_effects:[{id:fire_resistance, duration:6000}],rarity:uncommon,custom_name:'{"text":"Local Stew"}',lore:['{"text":"A local delicacy. Try it to see what special effects it might have!"}']}},maxUses:10}
execute if score _random_val var matches 4 run data modify entity @n[type=marker,tag=poi_marker,distance=..160] data.localStew set value {buy:{id:emerald,count:6},sell:{id:suspicious_stew,count:1,components:{suspicious_stew_effects:[{id:regeneration, duration:6000}],rarity:uncommon,custom_name:'{"text":"Local Stew"}',lore:['{"text":"A local delicacy. Try it to see what special effects it might have!"}']}},maxUses:10}
execute if score _random_val var matches 5 run data modify entity @n[type=marker,tag=poi_marker,distance=..160] data.localStew set value {buy:{id:emerald,count:6},sell:{id:suspicious_stew,count:1,components:{suspicious_stew_effects:[{id:jump_boost, duration:6000}],rarity:uncommon,custom_name:'{"text":"Local Stew"}',lore:['{"text":"A local delicacy. Try it to see what special effects it might have!"}']}},maxUses:10}
...
execute if score _currentPoiType var matches 4 run data modify entity @s Offers.Recipes[-1].sell.components."minecraft:custom_name" set value '{"text":"House Stew"}'
execute if score _currentPoiType var matches 4 run data modify entity @s Offers.Recipes[-1].sell.components."minecraft:lore"[0] set value '{"text":"A house special. Try it to see what special effects it might have!"}'
...
# Inkeepers will also sell beetroot stew, mushroom stew, and honey and water bottles
...
# Innkeepers (non-kingdom) will also sell a random cooked meat.
# (kingdom ones will sell all cooked meat, which is done after this by the calling function)
execute run scoreboard players set _random_val var 0
execute unless score _currentPoiType var matches 2 store result score _random_val var run function questcraft:get_random_in_range {randMin:1,randMax:4}
