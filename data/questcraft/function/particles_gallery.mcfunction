...
execute store result storage questcraft:args particlesGalleryDeltaScaleX float 0.02 run scoreboard players get _globals particlesGalleryDeltaX
execute store result storage questcraft:args particlesGalleryDeltaScaleY float 0.02 run scoreboard players get _globals particlesGalleryDeltaY
execute store result storage questcraft:args particlesGalleryDeltaScaleZ float 0.02 run scoreboard players get _globals particlesGalleryDeltaZ
execute store result storage questcraft:args particlesGalleryDeltaTranslationX float -0.01 run scoreboard players get _globals particlesGalleryDeltaX
execute store result storage questcraft:args particlesGalleryDeltaTranslationY float -0.01 run scoreboard players get _globals particlesGalleryDeltaY
execute store result storage questcraft:args particlesGalleryDeltaTranslationZ float -0.01 run scoreboard players get _globals particlesGalleryDeltaZ
...
function questcraft:particles_gallery_fix_color with storage questcraft:args
...
function questcraft:particles_gallery_sub with storage questcraft:args
