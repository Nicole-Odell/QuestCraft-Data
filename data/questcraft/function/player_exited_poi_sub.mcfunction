...
# Mansion
execute if score @s currentPoiType matches 3 unless entity @n[type=minecraft:marker,tag=poi_marker,tag=poi_marker_mansion,distance=..320] run function questcraft:player_exited_poi_sub_apply with storage questcraft:args
# Tavern
...
# Village
execute if score @s currentPoiType matches 6 unless entity @n[type=minecraft:marker,tag=poi_marker,tag=poi_marker_village,distance=..128] run function questcraft:player_exited_poi_sub_apply with storage questcraft:args