...
# The impact functions will add to this if we do damage
...
$execute positioned ^ ^ ^ as @e[type=#questcraft:is_attack_targetable,tag=!zealous_charge_hit_$(playerId),tag=zealous_charge_target_$(playerId),distance=..1.5] run function questcraft:templar_ability_zealous_charge_impact_target with storage questcraft:args
# Damage other enemies we hit during the charge. Don't damage mobs tat have already been hit once this charge
$execute positioned ^ ^ ^ as @e[type=#questcraft:is_attack_targetable,tag=!zealous_charge_hit_$(playerId),tag=!zealous_charge_target_$(playerId),distance=..2] run function questcraft:templar_ability_zealous_charge_impact with storage questcraft:args
...
$execute if score @s zealousChargeTime matches 0 run execute as @e[type=#questcraft:is_attack_targetable,tag=zealous_charge_hit_$(playerId),distance=..128] run function questcraft:templar_ability_zealous_charge_end with storage questcraft:args
