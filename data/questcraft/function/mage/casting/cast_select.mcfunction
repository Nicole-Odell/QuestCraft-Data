...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/vigor_minor/cast"
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/heal_minor/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/bloodbond/cast"
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/impact/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 4
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/firebolt/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 4
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/icewind/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/heal_major/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 8
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/ward/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 8
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/inner_warmth/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/cooling_aura/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 10
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/solar_ray/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/levitation/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 10
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/bumble_dry/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellCost set value 10
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/cleanse/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/hyperbeam/cast"
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args
...
# data modify storage questcraft:args spellFunction set value "questcraft:mage/spell/time_bargain/cast"
# execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_if_match with storage questcraft:args


# Fail the spell cast if we didn't match any spells
execute unless score _any_spell_matched var matches 1 run function questcraft:mage/casting/cast_fail_spell_not_found with storage questcraft:args
