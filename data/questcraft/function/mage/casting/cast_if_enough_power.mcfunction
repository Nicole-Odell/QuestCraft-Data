...
execute if score _is_spell_cast_with_raycast var matches 1 if score @s isCastingPrimed matches 1 run function questcraft:mage/casting/cast_finish_raycast with storage questcraft:args
...
execute if score _cast_source var matches 1 run function questcraft:mage/calculate_blood_bond_power with storage questcraft:args
...
execute if score _cast_possible var matches 0 run function questcraft:mage/casting/cast_fail_not_enough_power with storage questcraft:args

# If enough power, apply the cost to the source
execute if score _cast_source var matches 0 run execute if score _cast_possible var matches 1 run function questcraft:mage/casting/cost/deduct_food
execute if score _cast_source var matches 1 run execute if score _cast_possible var matches 1 run function questcraft:mage/casting/cost/deduct_health
execute if score _cast_source var matches 2 run execute if score _cast_possible var matches 1 run function questcraft:mage/casting/cost/deduct_soul
...
execute if score _cast_possible var matches 1 if score _is_spell_cast_with_raycast var matches 1 run function questcraft:mage/casting/target_raycast with storage questcraft:args

# Spell cast successfully. Finish the process for non-raycast spells, For raycast spells, the above function will handle it
execute if score _cast_possible var matches 1 unless score _is_spell_cast_with_raycast var matches 1 run function questcraft:mage/casting/cast_finish with storage questcraft:args
