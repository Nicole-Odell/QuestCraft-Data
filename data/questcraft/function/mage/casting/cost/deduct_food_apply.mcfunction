...
$execute if score _hunger_duration_at_240 var matches 1.. if score _hunger_remaining_amplifier var matches 1.. run schedule function questcraft:mage/casting/cost/deduct_food_apply_scheduled $(hungerDurationAt240)s append