...
$execute as @n[type=!player,tag=blood_bonded_$(mageId),tag=!blood_bonded_cost_taken] run function questcraft:mage/casting/cost/deduct_health_bond_step with storage questcraft:args
