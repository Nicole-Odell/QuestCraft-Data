...
execute unless score _original_cast_source var = _cast_source var run function questcraft:mage/casting/cast_cancel with storage questcraft:args

# If they do match, call the raycast confirm function and then the normal finish function
execute if score _original_cast_source var = _cast_source var run function questcraft:mage/casting/cast_finish_raycast_sub with storage questcraft:args
