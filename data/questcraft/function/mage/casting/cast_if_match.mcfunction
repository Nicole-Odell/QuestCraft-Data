...
execute if score _spell_matched var matches 1 run execute store success score _spell_cast_possible var run function questcraft:mage/casting/cast_if_enough_power with storage questcraft:args
