...
execute unless score @s isCastingPrimed matches 1 if score @s soul_aspect.charge = @s soul_aspect.maxCharge unless score @s soul_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:mage/casting/build/soul
...
execute if score @s isCastingPrimed matches 1 if score @s soul_aspect.charge = @s soul_aspect.maxCharge unless score @s soul_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:mage/casting/cast_raycast_confirm
...
execute if score @s soul_aspect.charge = @s spellCastingRequiredCastCharge run function questcraft:mage/casting/cast_base with storage questcraft:args
