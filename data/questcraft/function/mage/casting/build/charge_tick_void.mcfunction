...
execute if score @s void_aspect.charge = @s void_aspect.maxCharge run stopsound @a player minecraft:entity.illusioner.prepare_blindness
execute unless score @s isCastingPrimed matches 1 if score @s void_aspect.charge = @s void_aspect.maxCharge unless score @s void_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:mage/casting/build/void
...
execute if score @s isCastingPrimed matches 1 if score @s void_aspect.charge = @s void_aspect.maxCharge unless score @s void_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:mage/casting/cast_raycast_confirm
...
execute if score @s void_aspect.charge = @s spellCastingRequiredCastCharge run function questcraft:mage/casting/cast_base with storage questcraft:args
