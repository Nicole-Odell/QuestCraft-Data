...
execute at @s anchored eyes run function questcraft:projectile/launch {projectileEntity:"minecraft:area_effect_cloud", projectileSpeed:1, projectileSpeedOffsetLR:0, projectileSpeedOffsetUD:0, projectileTag:"impact_projectile", projectileData:"Duration:100", projectileTtl:6}
...
execute if score @s impactShotsInBurst matches 1.. run schedule function questcraft:mage/spell/impact/repeat 3t append
