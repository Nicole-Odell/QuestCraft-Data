...
execute at @s anchored eyes rotated as @s run function questcraft:projectile/launch {projectileEntity:"minecraft:area_effect_cloud", projectileSpeed:1, projectileSpeedOffsetLR:0, projectileSpeedOffsetUD:0, projectileTag:"icewind_projectile", projectileData:"Duration:120", projectileTtl:5}
