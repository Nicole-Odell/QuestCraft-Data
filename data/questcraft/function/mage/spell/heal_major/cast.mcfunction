...
execute at @s run particle minecraft:heart ^ ^1 ^0.25 0.3 0.5 0.3 0.5 8 force @a
...
execute if score _absorption_health_amplifier var matches 0.. unless predicate questcraft:has_absorption run function questcraft:mage/spell/heal_major/cast_sub with storage questcraft:args
