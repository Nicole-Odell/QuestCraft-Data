...
scoreboard players set _c_time_until_start var 43
...
execute if score _time_since_start var matches 3.. run particle end_rod ^ ^ ^-5 0 0 0 0 10 force
...
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^ 0 0 0 3 10 force
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^-1 0 0 0 3 10 force
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^-2 0 0 0 3 10 force
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^-2 0 0 0 3 10 force
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^-4 0 0 0 3 10 force
execute if score _time_since_start var matches 2.. run particle firework ^ ^ ^-5 0 0 0 3 10 force
...
execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^ ^ {fuse:0,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^1.5 ^ {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^-1.5 ^ {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^-1.5 ^ ^ {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^1.5 ^ ^ {fuse:2,block_state:{Name:"minecraft:air"}}

execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^ ^-1 {fuse:0,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^1.5 ^-1 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^-1.5 ^-1 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^-1.5 ^ ^-1 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^1.5 ^ ^-1 {fuse:2,block_state:{Name:"minecraft:air"}}

execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^ ^-2 {fuse:0,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^1.5 ^-2 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^-1.5 ^-2 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^-1.5 ^ ^-2 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^1.5 ^ ^-2 {fuse:2,block_state:{Name:"minecraft:air"}}

execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^ ^-3 {fuse:0,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^1.5 ^-3 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^-1.5 ^-3 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^-1.5 ^ ^-3 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^1.5 ^ ^-3 {fuse:2,block_state:{Name:"minecraft:air"}}

execute if score _time_since_start var matches 3.. at @s run summon tnt ^ ^ ^-4 {fuse:0,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^1.5 ^-4 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^ ^-1.5 ^-4 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^-1.5 ^ ^-4 {fuse:2,block_state:{Name:"minecraft:air"}}
# execute if score _time_since_start var matches 2.. at @s run summon tnt ^1.5 ^ ^-4 {fuse:2,block_state:{Name:"minecraft:air"}}

execute if score _time_since_start var matches 3.. at @s run summon tnt ^ ^ ^-5 {fuse:0,block_state:{Name:"minecraft:air"}}
