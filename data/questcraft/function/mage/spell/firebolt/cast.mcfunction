...
execute at @s anchored eyes run function questcraft:projectile/launch {projectileEntity:"minecraft:arrow", projectileSpeed:5, projectileSpeedOffsetLR:0., projectileSpeedOffsetUD:0, projectileTag:"firebolt_projectile", projectileData:"pickup:2,PierceLevel:10,Fire:2000,SoundEvent:'minecraft:entity.blaze.shoot'", projectileTtl:6}