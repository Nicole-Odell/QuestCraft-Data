...
execute if score @s blood_aspect.charge matches 0 at @s run playsound minecraft:entity.witch.drink player @a ~ ~ ~ 1 1.5 0
execute if score @s blood_aspect.charge matches 0 at @s run playsound minecraft:entity.blaze.hurt player @a ~ ~ ~ 1 2 0
