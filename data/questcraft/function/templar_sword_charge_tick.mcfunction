...
execute unless score @s templar.isAbilityPrimed matches 1 if score @s templar.swordCharge = @s templar.highestSwordCharge if score @s templar.swordCharge > @s templar.swordChargeToCast run function questcraft:templar_ability_right_click_hold
...
execute if score @s templar.swordCharge = @s templar.swordChargeToCast run function questcraft:templar_ability_right_click_hold_ready