...
execute if score _cast_source var matches 2 run execute store result score _caster_power_with_source var run scoreboard players get @s soulPower
...
# This is used by spell_casting_finish but it returns so we need to clean this up here
