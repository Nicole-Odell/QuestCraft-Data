...
execute if score @s blood_aspect.charge = @s blood_aspect.maxCharge unless score @s blood_aspect.charge > @s spellCastingCastCharge run function questcraft:spell_build_blood
...
execute if score @s blood_aspect.charge = @s spellCastingCastCharge run function questcraft:spell_casting_prime with storage questcraft:args
