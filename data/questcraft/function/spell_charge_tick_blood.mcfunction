...
execute if score @s blood_aspect.charge = @s blood_aspect.maxCharge unless score @s blood_aspect.charge > _globals spellCastingMaxCharge run function questcraft:spell_build_blood
...
execute if score @s blood_aspect.charge = _globals spellCastingMaxCharge run execute store result storage questcraft:args mageId int 1 run scoreboard players get @s mageId
