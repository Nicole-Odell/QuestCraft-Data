...
execute unless score @s isCastingPrimed matches 1 if score @s blood_aspect.charge = @s blood_aspect.maxCharge unless score @s blood_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:spell_build_blood
...
execute if score @s isCastingPrimed matches 1 if score @s blood_aspect.charge = @s blood_aspect.maxCharge unless score @s blood_aspect.charge > @s spellCastingRequiredCastCharge run function questcraft:spell_casting_cast_raycast_confirm
...
execute if score @s blood_aspect.charge = @s spellCastingRequiredCastCharge run function questcraft:spell_casting_base with storage questcraft:args
