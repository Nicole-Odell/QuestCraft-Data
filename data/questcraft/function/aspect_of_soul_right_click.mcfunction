...
# execute unless score @s soul_aspect.charge >= @s spellCastingCastCharge at @s anchored eyes run particle minecraft:soul_fire_flame ^-0.4 ^0.05 ^0.35 0.025 0.025 0.025 0.01 10 force @s
