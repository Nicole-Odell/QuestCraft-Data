...
execute if entity @s[gamemode=creative] if score @s currentPoiType matches 1.. unless entity @s[tag=actionbar_no_override] run function questcraft:poi_show_actionbar_status
execute if entity @s[gamemode=spectator] if score @s currentPoiType matches 1.. unless entity @s[tag=actionbar_no_override] run function questcraft:poi_show_actionbar_status
...
execute if score @s currentPoiType matches 1.. unless score _is_in_poison_water var matches 1 unless entity @s[tag=actionbar_no_override] run function questcraft:poi_show_actionbar_status
