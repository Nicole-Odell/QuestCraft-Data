...
# 2 below player. Only check 2x2 for this
...
execute if score _globals printDebug matches 1 if score @s isNearWarmth matches 1 run scoreboard players set _isWarmth var 1