...
execute if score _villager_type var matches 0 store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:99}
...
scoreboard players set _random_val var 0
execute if score _villager_type var matches 1 store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:99}
...
scoreboard players set _random_val var 0
execute if score _villager_type var matches 4 if score _villager_type var matches 4 run execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:79}
...
scoreboard players set _random_val var 0
execute if score _villager_type var matches 4 store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:64}
...
# Armor Basic
execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:329}
...
execute unless score _villager_type var matches 4 run execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:105}
...
# Sword basic
execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:539}
...
# Sword Special
execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:359}
...
# desert
execute if score _villager_type var matches 0 run function questcraft:villager_init_librarian_harsh_biome
# jungle
execute if score _villager_type var matches 1 run function questcraft:villager_init_librarian_normal_biome
# plains
execute if score _villager_type var matches 2 run function questcraft:villager_init_librarian_normal_biome
# savanna
execute if score _villager_type var matches 3 run function questcraft:villager_init_librarian_normal_biome
# snow
execute if score _villager_type var matches 4 run function questcraft:villager_init_librarian_harsh_biome
# swamp
execute if score _villager_type var matches 5 run function questcraft:villager_init_librarian_harsh_biome
# taiga 
execute if score _villager_type var matches 6 run function questcraft:villager_init_librarian_harsh_biome


# Tools
execute store result score _random_val var run function questcraft:get_random_in_range {randMin:0,randMax:179}
