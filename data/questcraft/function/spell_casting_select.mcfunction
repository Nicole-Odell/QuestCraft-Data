...
execute if score _spell_length var matches 2 run function questcraft:spell_casting_cast_if_match with storage questcraft:args
...
execute if score _spell_length var matches 3 run function questcraft:spell_casting_cast_if_match with storage questcraft:args
