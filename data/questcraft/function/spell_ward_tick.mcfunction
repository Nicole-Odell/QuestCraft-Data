...
execute if score @s wardTime matches ..60 run particle white_ash ~-1 ~1 ~ 0 0.6 0.5 0 3
execute if score @s wardTime matches ..60 run particle white_ash ~1 ~1 ~ 0 0.6 0.5 0 3
execute if score @s wardTime matches ..60 run particle white_ash ~ ~1 ~-1 0.5 0.6 0 0 3
execute if score @s wardTime matches ..60 run particle white_ash ~ ~1 ~1 0.5 0.6 0 0 3
execute if score @s wardTime matches ..60 run particle white_ash ~ ~2 ~ 0.6 0 0.6 0 3
execute if score @s wardTime matches ..60 run particle white_ash ~ ~ ~ 0.6 0 0.6 0 3
