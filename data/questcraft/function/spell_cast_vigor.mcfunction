tellraw @s {"bold":true,"color":"green","text":"Casted Spell using Vigor!"}
...
data modify storage questcraft:args castText set value "# Casted using Vigor # "
data modify storage questcraft:args color set value "green"
