...
$execute store result score _spell_display_buffer_content_length var run data get storage questcraft:mage_data mages[$(id)].spell
...
$execute store result score _spell_display_next_aspect var run data get storage questcraft:mage_data mages[$(id)].spell[$(index)]
