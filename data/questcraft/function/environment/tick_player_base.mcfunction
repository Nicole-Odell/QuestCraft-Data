...
execute if entity @s[gamemode=creative] run function questcraft:environment/player_temperature_meter_display
execute if entity @s[gamemode=spectator] run function questcraft:environment/player_temperature_meter_display
# Show the current POI actionbar title too
execute if entity @s[gamemode=creative] if score @s currentPoiType matches 1.. unless entity @s[tag=actionbar_no_override] run function questcraft:poi/show_actionbar_status
execute if entity @s[gamemode=spectator] if score @s currentPoiType matches 1.. unless entity @s[tag=actionbar_no_override] run function questcraft:poi/show_actionbar_status
...
execute if score _is_day_temperature var matches 1 run function questcraft:environment/tick_player_day_temperature
execute if score _is_night_temperature var matches 1 run function questcraft:environment/tick_player_night_temperature
execute if score _is_day_temperature var matches 0 if score _is_night_temperature var matches 0 run function questcraft:environment/tick_player_neutral_temperature
...
execute unless score @s temperature.wasEvaluatedThisTick matches 1 run function questcraft:environment/in_neutral
...
execute if score @s currentPoiType matches 1.. unless score _is_in_poison_water var matches 1 unless entity @s[tag=actionbar_no_override] run function questcraft:poi/show_actionbar_status
