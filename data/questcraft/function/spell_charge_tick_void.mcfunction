...
execute if score @s void_aspect.charge = @s void_aspect.maxCharge unless score @s void_aspect.charge > @s spellCastingCastCharge run function questcraft:spell_build_void
...
execute if score @s void_aspect.charge = @s spellCastingCastCharge run function questcraft:spell_casting_prime with storage questcraft:args
