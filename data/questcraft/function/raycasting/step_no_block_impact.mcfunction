...
execute store success score _raycast_completed var positioned ^ ^ ^0.1 run function questcraft:raycasting/step_no_block_impact with storage questcraft:args