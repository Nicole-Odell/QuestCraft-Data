...
function questcraft:poi/get_structure_details_from_id with storage questcraft:args

function questcraft:dm_tools/poi_mark_undiscovered_sub with storage questcraft:args
