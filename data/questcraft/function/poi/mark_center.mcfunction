...
execute at @s run function questcraft:poi/triangulate_center with storage questcraft:args
...
function questcraft:poi/mark_center_step with storage questcraft:args
function questcraft:poi/mark_center_step with storage questcraft:args
function questcraft:poi/mark_center_step with storage questcraft:args
function questcraft:poi/mark_center_step with storage questcraft:args
...
execute unless score _poiCenterX var matches 0 unless score _poiCenterZ var matches 0 run function questcraft:poi/mark_center_finish with storage questcraft:args
