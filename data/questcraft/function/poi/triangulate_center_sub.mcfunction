...
# Start the recursion
execute at @s run function questcraft:poi/triangulate_center_step with storage questcraft:args
...
execute at @s as @n[type=marker,tag=poi_locater_n_x] run function questcraft:utilities/tp_to_loc_surface with storage questcraft:args
