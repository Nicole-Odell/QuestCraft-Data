...
execute store result storage questcraft:args structure_name_id int 1 run function questcraft:utilities/get_random_in_range with storage questcraft:args

# Place the marker and set the name
function questcraft:poi/mark_center_finish_sub with storage questcraft:args

function questcraft:debug/print_coords_force with storage questcraft:args
