...
execute unless entity @n[type=marker,tag=poi_marker,distance=..160,nbt={data:{localStew:{}}}] store result score _random_val var run function questcraft:utilities/get_random_in_range {randMin:1,randMax:5}
...
execute run scoreboard players set _random_val var 0
execute unless score _currentPoiType var matches 2 unless score _villager_type var matches 0 store result score _random_val var run function questcraft:utilities/get_random_in_range {randMin:1,randMax:6}
# Fish aren't an option in deserts
execute unless score _currentPoiType var matches 2 if score _villager_type var matches 0 store result score _random_val var run function questcraft:utilities/get_random_in_range {randMin:1,randMax:4}
