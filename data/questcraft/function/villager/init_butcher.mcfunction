...
execute if score _currentPoiType var matches 4 run function questcraft:villager/init_butcher_inkeeper with storage questcraft:args
execute if score _currentPoiType var matches 2 run function questcraft:villager/init_butcher_inkeeper with storage questcraft:args
