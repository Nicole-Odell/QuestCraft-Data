...
# desert
execute if score _villager_type var matches 0 run function questcraft:villager/init_fletcher_harsh_biome

# jungle
execute if score _villager_type var matches 1 run function questcraft:villager/init_fletcher_normal_biome
...
# plains
execute if score _villager_type var matches 2 run function questcraft:villager/init_fletcher_normal_biome

# savanna
execute if score _villager_type var matches 3 run function questcraft:villager/init_fletcher_normal_biome

# snow
execute if score _villager_type var matches 4 run function questcraft:villager/init_fletcher_harsh_biome
...
# swamp
execute if score _villager_type var matches 5 run function questcraft:villager/init_fletcher_harsh_biome
...
# taiga 
execute if score _villager_type var matches 6 run function questcraft:villager/init_fletcher_harsh_biome
