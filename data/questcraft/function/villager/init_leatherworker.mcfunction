...
execute store result storage questcraft:args dyed_color int 1 run function questcraft:utilities/get_random_in_range {randMin:0,randMax:16777215}
function questcraft:villager/init_leatherworker_dyed with storage questcraft:args
