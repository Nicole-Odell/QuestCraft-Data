...
execute if score _currentPoiType var matches 2 run execute store result score _random_val var run function questcraft:utilities/get_random_in_range {randMin:1,randMax:20}
