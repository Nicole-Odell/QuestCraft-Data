...
execute if entity @s[nbt={VillagerData:{profession:"minecraft:armorer"}}] run function questcraft:villager/init_armorer
execute if entity @s[nbt={VillagerData:{profession:"minecraft:butcher"}}] run function questcraft:villager/init_butcher
execute if entity @s[nbt={VillagerData:{profession:"minecraft:cartographer"}}] run function questcraft:villager/init_cartographer
execute if entity @s[nbt={VillagerData:{profession:"minecraft:cleric"}}] run function questcraft:villager/init_cleric
execute if entity @s[nbt={VillagerData:{profession:"minecraft:farmer"}}] run function questcraft:villager/init_farmer
execute if entity @s[nbt={VillagerData:{profession:"minecraft:fisherman"}}] run function questcraft:villager/init_fisherman
execute if entity @s[nbt={VillagerData:{profession:"minecraft:fletcher"}}] run function questcraft:villager/init_fletcher
execute if entity @s[nbt={VillagerData:{profession:"minecraft:leatherworker"}}] run function questcraft:villager/init_leatherworker
execute if entity @s[nbt={VillagerData:{profession:"minecraft:librarian"}}] run function questcraft:villager/init_librarian
execute if entity @s[nbt={VillagerData:{profession:"minecraft:mason"}}] run function questcraft:villager/init_mason
execute if entity @s[nbt={VillagerData:{profession:"minecraft:shepherd"}}] run function questcraft:villager/init_shepherd
execute if entity @s[nbt={VillagerData:{profession:"minecraft:toolsmith"}}] run function questcraft:villager/init_toolsmith
execute if entity @s[nbt={VillagerData:{profession:"minecraft:weaponsmith"}}] run function questcraft:villager/init_weaponsmith
