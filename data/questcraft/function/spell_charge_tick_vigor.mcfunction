...
execute if score @s vigor_aspect.charge = @s vigor_aspect.maxCharge unless score @s vigor_aspect.charge > @s spellCastingCastCharge run function questcraft:spell_build_vigor
...
execute if score @s vigor_aspect.charge = @s spellCastingCastCharge run function questcraft:spell_casting_prime with storage questcraft:args