...
# Play the aspect sound if the click just started
execute if score @s vigor_aspect.charge matches 0 at @s run playsound minecraft:entity.player.levelup player @a ~ ~ ~ 1 1.9 0
