...
execute unless score _fire_time var matches 1.. run function questcraft:utilities/damage_target with storage questcraft:args
execute if score _fire_time var matches 1.. run function questcraft:utilities/damage_target_fire with storage questcraft:args

# PLay particle effects based on the special damage types
execute if score _damage_type var matches 1.. run particle minecraft:enchanted_hit ~ ~1 ~ 0 0.25 0 1 35 normal
execute if score _fire_time var matches 1.. run particle minecraft:flame ~ ~1 ~ 0.25 0.25 0.25 0.2 40 normal
