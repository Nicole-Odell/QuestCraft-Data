...
execute unless score @s temperature.wasEvaluatedThisTick matches 1 if score _is_snowing var matches 0 if biome ~ ~ ~ #questcraft:is_frozen run function questcraft:environment_player_freezing
execute unless score @s temperature.wasEvaluatedThisTick matches 1 if score _is_snowing var matches 1 if score _is_exposed_to_sky var matches 0 if biome ~ ~ ~ #questcraft:is_frozen run function questcraft:environment_player_freezing
execute unless score @s temperature.wasEvaluatedThisTick matches 1 if score _is_snowing var matches 1 if score _is_exposed_to_sky var matches 1 if biome ~ ~ ~ #questcraft:is_frozen run function questcraft:environment_player_critical_freezing
