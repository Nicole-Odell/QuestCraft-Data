...
data modify storage questcraft:args rayCastStepFunction set value "questcraft:templar_ability_heavenly_strike_raycast_step_particle"
...
execute facing entity @s eyes run function questcraft:raycast with storage questcraft:args
...
# Deal sword damage to targets in range. Deal meultiple times for the close they are to the center
execute as @e[type=#questcraft:is_attack_targetable,distance=..8] run function questcraft:templar_deal_sword_damage with storage questcraft:args
execute as @e[type=#questcraft:is_attack_targetable,distance=..6] run function questcraft:templar_deal_sword_damage with storage questcraft:args
execute as @e[type=#questcraft:is_attack_targetable,distance=..4] run function questcraft:templar_deal_sword_damage with storage questcraft:args
execute as @e[type=#questcraft:is_attack_targetable,distance=..2] run function questcraft:templar_deal_sword_damage with storage questcraft:args
